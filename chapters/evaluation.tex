...
To set a baseline, three different K8ssandra cluster setups, with one, two, and three nodes respectively, have been stress tested using \texttt{cassandra-stress}. All nodes were provisioned with limits of 2 CPUs and 6GB of memory. The amount of write requests that the tool will make is set to be 1000000, the exact call is listed in \Cref{lst:stress-1000000writes}. During these runs, no elasticity was involved.
